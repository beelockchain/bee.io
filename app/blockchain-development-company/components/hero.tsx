    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 py-10 gap-6 -mt-10 md:-mt-16 lg:mt-13 xl:mt-13">
          ...
          <h1 className="text-[#000000] font-manrope font-semibold text-[20px] md:text-[20px] lg:text-[25px] xl:text-[45px] leading-tight tracking-tight drop-shadow-[0_2px_24px_rgba(0,220,200,.35)]">
            Blockchain Development Services
          </h1>
        ...
        <div className="fixed md:right-10 lg:right-5 xl:right-10 top-[50%] -translate-y-1/2 z-30 hidden lg:flex flex-col items-center gap-6">
          <div className="flex flex-col items-center gap-6 px-5 py-6 rounded-[42px] bg-[#2f7c7f] border-white backdrop-blur-md border ">
            <div className="flex flex-col gap-4">
              {socialLinks.map((social, index) => (
                <a key={index} href={social.url} target="_blank" rel="noopener noreferrer" aria-label={social.label}
                  className="w-5 h-5 flex items-center justify-center rounded-xl text-white hover:text-cyan-400 transition-all duration-300 hover:scale-110">
