...
<footer className="relative w-full bg-[#00020f] overflow-hidden flex flex-col items-center">
  ...
  {/* ================= DESKTOP / TABLET ================= */}
  <div className="hidden sm:block md:block relative w-full bg-[#00020f] overflow-hidden min-h-[1000px] md:min-h-[800px]  lg:min-h-[800px] xl:min-h-[800px]">
